package com.cie.nems.common.jdbc.internal;
...
import com.cie.nems.common.jdbc.ColumnAlias;
...
public class BeanProcessor {
	...
	protected int[] mapColumnsToProperties(ResultSetMetaData rsmd, PropertyDescriptor[] props, Class<?> type)
		...
		for (int col = 1; col <= cols; col++) {
			...
			columnName = convertColumnToProperty(columnName);
